...
#colors
startColor = ImageColor.getcolor("#D62828", "RGB")
bgColor = ImageColor.getcolor("#FCBF49", "RGB")
wallColor = ImageColor.getcolor("#003049", "RGB")
pathColor = ImageColor.getcolor("#EAE2B7", "RGB")
goalColor = ImageColor.getcolor("#5DF95D", "RGB")
goalPathColor = ImageColor.getcolor("#F77F00", "RGB")
    ...
    for event in pygame.event.get(): 
        if event.type == pygame.QUIT:
             ...
             if event.key == pygame.K_s:    # S to save
                 print("Saving Maze")
                 savegrid()
             if event.key == pygame.K_l:    # L to load
                 print("Loading Maze")
                 loadgrid(0)
             if event.key == pygame.K_f:    # F to Fill
                 print("Filling Maze")
                 grid = [[1 for x in range(33)] for y in range(33)]
                # Load presets by pressing key from 1 - 5
             ...
             if event.key == pygame.K_5:
                 ...
                 loadgrid(5)
                # End of loading
             if event.key == pygame.K_RETURN:   # Enter to solve
